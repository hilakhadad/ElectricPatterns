...
from disaggregation.rectangle.pipeline.detection_step import process_detection
from disaggregation.rectangle.pipeline.matching_step import process_matching
from disaggregation.rectangle.pipeline.segmentation_step import process_segmentation
from disaggregation.rectangle.pipeline.evaluation_step import process_evaluation
from disaggregation.rectangle.pipeline.visualization_step import process_visualization
