...
LOCAL_INPUT_PATH = r"C:\path\to\your\test\data"  # ← CHANGE THIS PATH

# Set this to where you want outputs to be saved
LOCAL_OUTPUT_PATH = r"C:\path\to\your\test\output"  # ← CHANGE THIS PATH
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f"{LOCAL_OUTPUT_PATH}/logs/test_{HOUSE_ID}.log"),
...
def run_on_off_detection():
    ...
    try:
        from on_off_log import process_on_off_log
        ...
        process_on_off_log(
            ...
            input_directory=LOCAL_INPUT_PATH,
...
def run_matching():
    ...
    try:
        from new_matcher import process_matching
        output_dir = f"{LOCAL_OUTPUT_PATH}/run_{RUN_NUMBER}/house_{HOUSE_ID}"
...
def run_segmentation():
    ...
    try:
        ...
        process_segmentation(
            ...
            run_number=RUN_NUMBER,
            input_directory=LOCAL_INPUT_PATH,
            output_directory=f"{LOCAL_OUTPUT_PATH}/run_{RUN_NUMBER}/house_{HOUSE_ID}"
        )
...
def run_evaluation():
    ...
    try:
        from eval_segmentation import process_eval
        output_dir = f"{LOCAL_OUTPUT_PATH}/run_{RUN_NUMBER}/house_{HOUSE_ID}"
